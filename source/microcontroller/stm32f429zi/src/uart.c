...
{
	HAL_UART_Transmit_DMA(&huart3, (const uint8_t*)pBuff, buffSize);
}

// int __io_putchar(int ch)
// {
// 	char c = ch;
// 	//HAL_UART_Transmit_DMA(&huart3, (const uint8_t*)&ch, 4);
// 	HAL_UART_Transmit(&huart3, (const uint8_t*)&c, 1, 1000);
// 	return 1;
// }
