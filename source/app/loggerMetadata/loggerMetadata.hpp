...
struct loggerMetadata
{
	...
	uint8_t fileCreationPeriod;			// loggerSubsystem has to create files, this parameter indicates how often it does. (for more information, read externalStorage_component.hpp documentation)
